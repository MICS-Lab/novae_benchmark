...
def leiden(adata, n_clusters, key_added="SEDR", random_seed=2023, use_rep: bool = None):
...
def louvain(adata, n_clusters, key_added="SEDR", random_seed=2023, use_rep: bool = None):
    sc.pp.neighbor(adata, use_rep=use_rep)
